...
func (UserRole) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_user_c909cb02e7b20f2d, []int{0}
}
...
func (*UserProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_user_c909cb02e7b20f2d, []int{1}
}
...
func init() { proto.RegisterFile("users/v1/user.proto", fileDescriptor_user_c909cb02e7b20f2d) }
func init() { golang_proto.RegisterFile("users/v1/user.proto", fileDescriptor_user_c909cb02e7b20f2d) }

var fileDescriptor_user_c909cb02e7b20f2d = []byte{
