...
func request_ProfilesService_Health_0(ctx context.Context, marshaler runtime.Marshaler, client ProfilesServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterProfilesServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProfilesServiceClient) error {
	...
	mux.Handle("GET", pattern_ProfilesService_Health_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ProfilesService_Health_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_ProfilesService_Health_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	forward_ProfilesService_Health_0 = runtime.ForwardResponseMessage
)
